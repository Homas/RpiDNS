...
function initSQLiteDB($DBF){
  ...
  $sql="".
			 //"drop table queries_raw;\ndrop table queries_5m;\ndrop table queries_1h;\ndrop table queries_1d; drop table hits_raw;\n drop table hits_5m;\n drop table hits_1h;\n drop table hits_1d;\n".
		   "create table if not exists queries_raw (dt integer, client_ip text, client_port text, fqdn text, type text, class text, options text, server text, action text);\n".
		   ...
		   "create table if not exists hits_raw (dt integer, client_ip text, client_port text, fqdn text, action text, rule_type text, rule text, feed text);\n".
		   ...
		   "create table if not exists queries_5m (dt integer, client_ip text, fqdn text, type text, class text, options text, server text, action text, cnt integer);\n".
		   ...
		   "create table if not exists hits_5m (dt integer, client_ip text, fqdn text, action text, rule_type text, rule text, feed text, cnt integer);\n".
		   ...
		   "create table if not exists queries_1h (dt integer, client_ip text, fqdn text, type text, class text, options text, server text, action text, cnt integer);\n".
		   ...
		   "create table if not exists hits_1h (dt integer, client_ip text, fqdn text, action text, rule_type text, rule text, feed text, cnt integer);\n".
		   ...
		   "create table if not exists queries_1d (dt integer, client_ip text, fqdn text, type text, class text, options text, server text, action text, cnt integer);\n".
		   ...
		   "create table if not exists hits_1d (dt integer, client_ip text, fqdn text, action text, rule_type text, rule text, feed text, cnt integer);\n".
