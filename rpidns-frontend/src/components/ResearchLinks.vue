<template>
  <span>
    ...
    - <a target="_blank" :href="'https://community.riskiq.com/search/' + domain">RiskIQ Community</a><br>
    ...
    - <a target="_blank" :href="'https://apility.io/search/' + domain">Apility.io</a><br>
