...
//        { key: 'feed', label: 'Feed', sortable: true},
      ...
      qps_series_sample: [
        ...
        chart: {
			...
			retention_fields: [
				{ key: '0', label: 'Table', },
				{ key: '1', label: 'Size',  'tdClass':'width100 d-none d-md-table-cell', 'thClass': 'width100 d-none d-md-table-cell', formatter: (value) => { return value<1024?value+' b':value<1024*1024?Math.round(value/1024/1024*100)/100+' Kb':value<1024*1024*1024?Math.round(value/1024/1024*100)/100+' Mb':Math.round(value/1024/1024/1024*100)/100+' Gb'} },
				{ key: '2', label: 'Rows',  'tdClass':'width100 d-none d-md-table-cell', 'thClass': 'width100 d-none d-md-table-cell', },
