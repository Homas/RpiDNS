...
//        { key: 'feed', label: 'Feed', sortable: true},
      ...
      qps_series_sample: [
        ...
        { key: '3', label: 'From',  'tdClass':'width050 d-none d-md-table-cell', 'thClass': 'd-none d-md-table-cell',   formatter: (value) => { var date = new Date(value); return date.toLocaleString(); }},
        { key: '4', label: 'To',  'tdClass':'width050 d-none d-md-table-cell', 'thClass': 'd-none d-md-table-cell',   formatter: (value) => { var date = new Date(value); return date.toLocaleString(); }},
